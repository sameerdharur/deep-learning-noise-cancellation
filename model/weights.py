...
input_dense_weights = np.array([-10, 0, -3, 1, -8, -6, 3, -13, 1, 0, -3, -7, -5, -3, 6, -1, -6, 0, -6, -4, -1, -2, 1, 1, -7, 2, 21, 10, -5, -20, 24, 23, 37, 8, -2, 33, -6, 22, 13, -2, 50, 8, 13, 1, -15, 30, -10, 30, 0, 3, 5, 27, 1, 4, -3, 41,
   ...
   14, 6, 9, 26, 25, -25, -25, -18]).reshape((42,24))

input_dense_bias = np.array([38, -6, 127, 127, 127, -43, -127, 78,
   127, 5, 127, 123, 127, 127, -128, -76,
   -126, 28, 127, 125, -30, 127, -89, -20])

l = []
l.append(input_dense_weights/256)
l.append(input_dense_bias/256)

vad_gru_weights = np.array([-124, 23, -123, -33, -95, -4, 8, -84,
   ...
   -6, -17, 4, -111, -52, 27, 65, 0], dtype=np.float32).reshape((24,72))

vad_gru_recurrent_weights = np.array([65, 83, 35, 56, 24, -34, -28, -2,
   ...
   -73, 127, -8, -80, 46, -48, 4, -54], dtype=np.float32).reshape((24,72))


vad_gru_bias = np.array([124, 125, -57, -126, 53, 123, 127, -75,
...
m.append(vad_gru_weights/256)
m.append(vad_gru_recurrent_weights/256)
m.append(vad_gru_bias/256)


noise_gru_weights = np.array([-10, -8, 5, -72, 7, 55, -38, 3,
   ...
   -70, -4, -15, -30, 35, 48, -119, -63], dtype=np.float32).reshape((90,144))


noise_gru_recurrent_weights = np.array([20, -47, 122, 31, 41, -36, 18, -22,
   ...
   -98, 124, -115, -18, -116, 35, 10, -125], dtype=np.float32).reshape((48,144))

noise_gru_bias = np.array([51, 32, 88, 60, -64, 92, 5, -36,
   ...
   -23, -64, 31, 86, -50, 2, -38, 7], dtype=np.float32)

n = []
n.append(noise_gru_weights/256)
n.append(noise_gru_recurrent_weights/256)
n.append(noise_gru_bias/256)

denoise_gru_weights = np.array([-53, 26, -20, 28, -57, -30, -79, 58,
   ...
   22, 11, 0, 1, -1, 16, 6, -9], dtype=np.float32).reshape((114,288))


denoise_gru_recurrent_weights = np.array([-76, -99, -23, -18, 12, -119, -3, -53,
   ...
   22, -35, 69, -50, 7, -17, 64, -58], dtype=np.float32).reshape((96,288))


denoise_gru_bias = np.array([   -41, -76, -24, -96, 25, 117, -55, 54,
...
o = []
o.append(denoise_gru_weights/256)
o.append(denoise_gru_recurrent_weights/256)
o.append(denoise_gru_bias/256)

denoise_output_weights=np.array([24, 90, 127, 108, 73, 38, 24, 13,
   ...
   7, 12, 18, 20, 26, 33, 27, 30], dtype=np.float32).reshape((96,22))

denoise_output_bias=np.array([-82, -66, -125, -95, -127, -127, -127, -127,
   -127, -94, -113, -127, -80, -65, -109, -127,
   -126, -105, -53, -49, -18, -9],dtype=np.float32)



p = []
p.append(denoise_output_weights/256)
p.append(denoise_output_bias/256)

vad_output_weights = np.array([
        127, 127, 127, 127, 127, 20, 127, -126,
        -126, -54, 14, 125, -126, -126, 127, -125,
        -126, 127, -127, -127, -57, -30, 127, 80],
                                  dtype=np.float32).reshape((24, 1))

vad_output_bias = np.array([-50], dtype=np.float32)
q = []
q.append(vad_output_weights/256)
q.append(vad_output_bias/256)
